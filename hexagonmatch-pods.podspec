...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of hexagonmatch-pods.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/mpatinogu/hexagonmatch-pods'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'mpatinogu' => 'admin@hexagondata.io' }
  s.source           = { :git => 'https://github.com/mpatinogu/hexagonmatch-pods.git', :tag => s.version.to_s }
